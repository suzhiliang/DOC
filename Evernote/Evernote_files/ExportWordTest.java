...
public class ExportWordTest {
	public void createDocContext(String file) throws DocumentException, IOException {
		...
		String contextString = "iText是一个能够快速产生PDF文件的java类库。" + " \n"// 换行 +
				...
				+ "表格，图形的只读文档是很有用的。它的类库尤其与java Servlet有很好的给合。" + "使用iText与PDF能够使你正确的控制Servlet的输出。";
		...
		Paragraph underline = new Paragraph("下划线的实现",
				FontFactory.getFont(FontFactory.HELVETICA_BOLDOBLIQUE, 18, Font.UNDERLINE, new Color(0, 0, 255)));
		...
		Image img = Image.getInstance("C:/Users/Administrator/Desktop/临时文件/852011316825493322.jpg");
